...
```
## Output:
![1](https://github.com/Rajeshkannan-Muthukumar/PCA-Simple-warp-divergence---Implement-Sum-Reduction./assets/93901857/85a81951-4d66-4c94-b388-7d5c0023bda9)
...
Thus Implementation of the kernel reduceUnrolling16 is done and the performance of kernal reduceUnrolling16 is comapared with kernal reduceUnrolling8 using proper metrics and events with nvprof.
